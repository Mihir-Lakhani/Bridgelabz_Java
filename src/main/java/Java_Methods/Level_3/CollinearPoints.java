...
public class CollinearPoints {
    ...
    public static boolean UsingSlope(double x1, double y1,
                                     double x2, double y2,
                                     double x3, double y3){
    ...
    public static boolean UsingArea(double x1, double y1,
                                    double x2, double y2,
                                    double x3, double y3){
    ...
    public static void main(String[] args) {
        ...
        System.out.printf(
                "The Points are %s Collinear using Slope Formula\n",
                (UsingSlope(x1,y1,x2,y2,x3,y3)) ? "Indeed" : "Not"
        );

        System.out.printf(
                "The Points are %s Collinear using Area Formula\n",
                (UsingArea(x1,y1,x2,y2,x3,y3)) ? "Indeed" : "Not"
        );
    }
}